...
//          $this->utilityFuncs->throwException('no_template_file');
    ...
    protected function fillDefaultMarkers()
    {
        ...
        if (isset($parameters['formhandler_eID_middleware_ajaxmethod'])) {
            unset($parameters['formhandler_eID_middleware_ajaxmethod']);
        }
                                    ...
                                    foreach ($fieldSettings['errorCheck.'] as $key => $check) {
                                        switch ($check) {
                                            ...
                                            case 'fileMaxCount':
                                                ...
                                                // fix - cast to array to avoid warnings
                                                $fileCount = count((Array) $sessionFiles[$replacedFieldname]);
